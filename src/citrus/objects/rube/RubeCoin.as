/**
 * @author Tungstene
 * @version 1.0.0 - 05/06/2013 19:55
 */
...
package citrus.objects.rube 
{
	...
	public class RubeCoin extends Coin implements IRubeObject 
	{
		...
		//-----------------------------------------------------------------------------------------
		public function RubeCoin( name:String, params:Object = null, oBody:Object = null ):void 
		{
			//-------------------------------------------------------
			super( name, params );
			//-------------------------------------------------------
