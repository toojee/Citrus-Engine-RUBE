/**
 * @author Tungstene
 * @version 1.0.0 - 05/06/2013 19:41
 */
...
package citrus.objects.rube 
{
	...
	public class RubeEnemy extends Enemy implements IRubeObject 
	{
		...
		//-----------------------------------------------------------------------------------------
		public function RubeEnemy( name:String, params:Object = null, oBody:Object = null ):void 
		{
			//-------------------------------------------------------
			super( name, params );
			//-------------------------------------------------------
			...
			//-------------------------------------------------------
			if ( params && params.leftBound )  leftBound  = params.leftBound * _box2D.scale;
			if ( params && params.rightBound ) rightBound = params.rightBound * _box2D.scale;
			//-------------------------------------------------------
			this.oBody = oBody;
		}
		//-----------------------------------------------------------------------------------------
