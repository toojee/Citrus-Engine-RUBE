/**
 * @author Tungstene
 * @version 1.0.0 - 06/06/2013 10:27
 */
...
package citrus.objects.rube 
{
	...
	public class RubeSensor extends Sensor implements IRubeObject 
	{
		...
		//-----------------------------------------------------------------------------------------
		public function RubeSensor( name:String, params:Object = null, oBody:Object = null ):void 
		{
			//-------------------------------------------------------
			super( name, params );
			//-------------------------------------------------------
